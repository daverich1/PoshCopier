...
def fill_listing_form(
    ...
    # Poshmark Home, WomenBags, and WomenSkincare categories do not expose a
    # Size control.
    ...
    if (
        ...
        or category_value.casefold().startswith("womenskincare")
    ):
        print(
            "Size not applicable for Home, WomenBags, or WomenSkincare "
            "category; "
